...
const About = (props) => {
  return (
    <div className="about-container">
      <Helmet>
        <title>About - Jorge Emanuel</title>
        <meta property="og:title" content="About - Jorge Emanuel" />
      </Helmet>
      ...
      <div className="about-post-details">
        <div className="about-container01">
          <svg viewBox="0 0 1170.2857142857142 1024" className="about-icon">
        ...
        <span className="about-text01 textXL">posted 18 Sept 2021</span>
        <span className="about-text02">
          ...
          <span className="about-text05">Mark Jonson</span>
          <br></br>
        </span>
      ...
      <div className="about-container02">
        <div className="about-story">
          <span className="about-text08 textLG">
            <span>March 1, 2019</span>
          </span>
          <h3 className="about-text10 text2XL">
          ...
          />
          <span className="about-text11 textLG">
          ...
          <div className="about-container03">
            <span className="textLG">
              <span className="about-text17">&quot;</span>
              <span className="about-text18">
                And thank you for turning my personal jean jacket into a couture
                piece.
              </span>
              <span className="about-text19">&quot;</span>
            </span>
            <span className="about-text20">
              <span className="about-text21">Kanye West, Producer.</span>
              <span className="about-text22"></span>
            </span>
          </div>
          <h3 className="about-text23 text2XL">
            Using Video Games To Generate Clicks
          </h3>
          <span className="about-text24 textLG">
          ...
          />
          <h3 className="about-text26 text2XL">Rest of the Story</h3>
          <span className="about-text27 textLG">
          ...
          <div className="about-post">
            <span className="about-text35 textXL">What people say...</span>
            ...
            <div className="about-container04">
              <div className="about-container05">
                ...
                <div className="about-container06">
                  <span className="about-text36 textSM">JOHN SNOW</span>
                  <div className="about-container07">
                    <span className="about-text37 textXS">3 days ago</span>
                  </div>
                </div>
              </div>
              <SecondaryButton button="FOLLOW"></SecondaryButton>
            </div>
            <span className="about-text38 textMD">
            ...
            <div className="about-container08">
              <div className="about-container09">
                ...
                <span className="about-text40 textXS">150</span>
                ...
                <span className="about-text41 textXS">36</span>
                ...
                <span className="about-text42 textXS">12</span>
              </div>
              <div className="about-container10">
                ...
                />
                <span className="about-text43 textXS">and 30+ more</span>
              </div>
            </div>
            <div className="about-divider1"></div>
            <span className="about-text44 textSM">Load previous</span>
            <PostReaction
              name="Michael Lewis"
              likes="3"
            ...
            ></PostReaction>
            <span className="about-text45 textSM">Load next</span>
            <div className="about-container11">
              ...
              <textarea
                ...
                className="about-textarea textarea textSM"
              ></textarea>
            </div>
          </div>
        </div>
      ...
      <div className="about-posts">
        <div className="about-container12">
          ...
          <h3 className="about-text46 healine">
            <span className="about-text47">Before I go </span>
          </h3>
          <span className="about-text48 textXL">
