  ...
  return (
    <div className="servios-container">
      ...
      <div className="servios-hero">
        ...
        <h1 className="servios-text text2XL">About Page</h1>
        <div className="servios-bg"></div>
      </div>
      <div className="servios-post-details">
        <div className="servios-container01">
        ...
        <span className="servios-text01 textXL">posted 18 Sept 2021</span>
        <span className="servios-text02">
          <span className="servios-text03">
            &apos;Started from the bottom now we here&apos;
          </span>
          <span className="servios-text04">
            -
            <span
          ...
          <span className="servios-text05">Mark Jonson</span>
          <br></br>
        </span>
        <span className="servios-text06">
          <span className="servios-text07">
      ...
      <div className="servios-container02">
        <div className="servios-story">
          <span className="servios-text08 textLG">
            <span>March 1, 2019</span>
          </span>
          <h3 className="servios-text10 text2XL">
            The Castle Looks Different at Night...
          </h3>
          <img
            alt="image"
            src="/playground_assets/new-york-city-1400w.jpg"
            className="servios-image"
          />
          <span className="servios-text11 textLG">
            <span className="servios-text12">
          ...
          <div className="servios-container03">
            <span className="textLG">
              <span className="servios-text17">&quot;</span>
              <span className="servios-text18">
                And thank you for turning my personal jean jacket into a couture
                piece.
              </span>
              <span className="servios-text19">&quot;</span>
            </span>
            <span className="servios-text20">
              <span className="servios-text21">Kanye West, Producer.</span>
              <span className="servios-text22"></span>
            </span>
          </div>
          <h3 className="servios-text23 text2XL">
            Using Video Games To Generate Clicks
          </h3>
          <span className="servios-text24 textLG">
            <span className="servios-text25">
              This is the paragraph where you can write more details about your
              product. Keep you user engaged by providing meaningful
              information. Remember that by this time, the user is curious,
              otherwise he wouldn&apos;t scroll to get here. Add a button if you
          ...
          <img
            ...
            className="servios-image1"
          />
          <h3 className="servios-text26 text2XL">Rest of the Story</h3>
          <span className="servios-text27 textLG">
            <span className="servios-text28">
          ...
          <div className="servios-post">
            <span className="servios-text35 textXL">What people say...</span>
            <div className="servios-divider"></div>
            <div className="servios-container04">
              <div className="servios-container05">
                <img
                  alt="image"
                  src="/playground_assets/team5-1400w.jpg"
                  className="servios-image2"
                />
                <div className="servios-container06">
                  <span className="servios-text36 textSM">JOHN SNOW</span>
                  <div className="servios-container07">
                    <span className="servios-text37 textXS">3 days ago</span>
                  </div>
                </div>
              </div>
              <SecondaryButton button="FOLLOW"></SecondaryButton>
            </div>
            <span className="servios-text38 textMD">
              <span className="servios-text39">
            ...
            <img
              alt="image"
              src="/playground_assets/new-york-city-1400w.jpg"
              className="servios-image3"
            />
            <div className="servios-container08">
              <div className="servios-container09">
                ...
                <span className="servios-text40 textXS">150</span>
                <svg viewBox="0 0 1024 1024" className="servios-icon4">
                ...
                <span className="servios-text41 textXS">36</span>
                <svg viewBox="0 0 1024 1024" className="servios-icon6">
                ...
                <span className="servios-text42 textXS">12</span>
              </div>
              <div className="servios-container10">
                <img
                  alt="image"
                  src="/playground_assets/team5-1400w.jpg"
                  className="servios-image4"
                />
                <img
                  alt="image"
                  src="/playground_assets/team6-200h.jpg"
                  className="servios-image5"
                />
                <img
                  alt="image"
                  src="/playground_assets/team1-200h.jpg"
                  className="servios-image6"
                />
                <span className="servios-text43 textXS">and 30+ more</span>
              </div>
            </div>
            <div className="servios-divider1"></div>
            <span className="servios-text44 textSM">Load previous</span>
            <PostReaction
              name="Michael Lewis"
              likes="3"
            ...
            ></PostReaction>
            <span className="servios-text45 textSM">Load next</span>
            <div className="servios-container11">
              <img
                alt="image"
                src="/playground_assets/team4-200h.png"
                className="servios-image7"
              />
              <textarea
                rows="1"
                placeholder="Write your comment"
                className="servios-textarea textarea textSM"
              ></textarea>
            </div>
          </div>
        </div>
      </div>
      <div className="servios-posts">
        <div className="servios-container12">
          <Label text="STORIES"></Label>
          <h3 className="servios-text46 healine">
            <span className="servios-text47">Before I go </span>
          </h3>
          <span className="servios-text48 textXL">
