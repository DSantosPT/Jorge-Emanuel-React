...
const Test = (props) => {
  return (
    <div className="test-container">
      <Helmet>
        <title>Test - Jorge Emanuel</title>
        <meta property="og:title" content="Test - Jorge Emanuel" />
      </Helmet>
      <div className="test-hero">
        <div className="test-fixed-header">
          <Header rootClassName="header-root-class-name1"></Header>
        </div>
        <h1 className="test-text text2XL">This is a test</h1>
        <div className="test-bg"></div>
      </div>
      <div className="test-post-details">
        <div className="test-container01">
          <svg viewBox="0 0 1170.2857142857142 1024" className="test-icon">
        ...
        <span className="test-text01 textXL">posted 18 Sept 2021</span>
        <span className="test-text02">
          <span className="test-text03">
            &apos;Started from the bottom now we here&apos;
          </span>
          <span className="test-text04">
            -
            <span
          ...
          <span className="test-text05">Mark Jonson</span>
          <br></br>
        </span>
        <span className="test-text06">
          <span className="test-text07">
      ...
      <div className="test-container02">
        <div className="test-story">
          <span className="test-text08 textLG">
            <span>March 1, 2019</span>
          </span>
          <h3 className="test-text10 text2XL">
          ...
          />
          <span className="test-text11 textLG">
          ...
          <div className="test-container03">
            <span className="textLG">
              <span className="test-text17">&quot;</span>
              <span className="test-text18">
                And thank you for turning my personal jean jacket into a couture
                piece.
              </span>
              <span className="test-text19">&quot;</span>
            </span>
            <span className="test-text20">
              <span className="test-text21">Kanye West, Producer.</span>
              <span className="test-text22"></span>
            </span>
          </div>
          <h3 className="test-text23 text2XL">
            Using Video Games To Generate Clicks
          </h3>
          <span className="test-text24 textLG">
            <span className="test-text25">
              This is the paragraph where you can write more details about your
              product. Keep you user engaged by providing meaningful
              information. Remember that by this time, the user is curious,
              otherwise he wouldn&apos;t scroll to get here. Add a button if you
          ...
          <img
            ...
            className="test-image1"
          />
          <h3 className="test-text26 text2XL">Rest of the Story</h3>
          <span className="test-text27 textLG">
            <span className="test-text28">
          ...
          <div className="test-post">
            <span className="test-text35 textXL">What people say...</span>
            ...
            <div className="test-container04">
              <div className="test-container05">
                <img
                  ...
                  className="test-image2"
                />
                <div className="test-container06">
                  <span className="test-text36 textSM">JOHN SNOW</span>
                  <div className="test-container07">
                    <span className="test-text37 textXS">3 days ago</span>
                  </div>
                </div>
              </div>
              <SecondaryButton button="FOLLOW"></SecondaryButton>
            </div>
            <span className="test-text38 textMD">
              <span className="test-text39">
            ...
            <div className="test-container08">
              <div className="test-container09">
                ...
                <span className="test-text40 textXS">150</span>
                ...
                <span className="test-text41 textXS">36</span>
                <svg viewBox="0 0 1024 1024" className="test-icon6">
                ...
                <span className="test-text42 textXS">12</span>
              </div>
              <div className="test-container10">
                <img
                  alt="image"
                  src="/playground_assets/team5-1400w.jpg"
                  className="test-image4"
                />
                <img
                  alt="image"
                  src="/playground_assets/team6-200h.jpg"
                  className="test-image5"
                />
                <img
                  alt="image"
                  src="/playground_assets/team1-200h.jpg"
                  className="test-image6"
                />
                <span className="test-text43 textXS">and 30+ more</span>
              </div>
            </div>
            <div className="test-divider1"></div>
            <span className="test-text44 textSM">Load previous</span>
            <PostReaction
              name="Michael Lewis"
              likes="3"
            ...
            ></PostReaction>
            <span className="test-text45 textSM">Load next</span>
            <div className="test-container11">
              <img
                alt="image"
                src="/playground_assets/team4-200h.png"
                className="test-image7"
              />
              <textarea
                rows="1"
                placeholder="Write your comment"
                className="test-textarea textarea textSM"
              ></textarea>
            </div>
          </div>
        </div>
      ...
      <div className="test-posts">
        <div className="test-container12">
          ...
          <h3 className="test-text46 healine">
            <span className="test-text47">Before I go </span>
          </h3>
          <span className="test-text48 textXL">
